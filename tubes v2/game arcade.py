...
pirates_shoot = 'shoot.png'
monster_attack = 'fireball.png'
lives = 'lives.png'
coin = 'coin.png'
...
background_music = pygame.mixer.music.load('main.mp3')
get_coin = pygame.mixer.Sound('sfx coin.mp3')
...
class Game:
    ...
    def start_text(self):
        ...
        text = font.render('Bounty Hunter', True, 'red')
        text_rect = text.get_rect(center=(s_width/2, s_height/2))
        screen.blit(text, text_rect)
 
        font2 = pygame.font.SysFont('Calibri', 20)
        text2 = font2.render('press <enter> to play', True, 'black')
    ...
    def start_screen(self):
        ...
        background_image = pygame.image.load("oalah.jpg").convert()
    ...
    def how_to_play_screen(self):
        background_image = pygame.image.load("bg htpp.jpg").convert()
        background_rect = background_image.get_rect()
        background_image = pygame.transform.scale(background_image, (s_width, s_height))
        screen.blit(background_image, background_rect)
        while True: 
    ...
    def player_monster_crash(self):
        if self.player.image.get_alpha() == 255:
            hits = pygame.sprite.groupcollide(player_group, monster_group, False, False)
            if hits:
                for i in hits:
                    i.rect.x = -199
                    self.lives -= 1
